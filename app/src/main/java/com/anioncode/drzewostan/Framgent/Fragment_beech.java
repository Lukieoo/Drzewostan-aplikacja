...
public class Fragment_beech extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseUniversal(view.getContext(), "BEECH");
        //   populate1();
        arrayList = new ArrayList<>();
        arrayList = databaseHelper.getAllData();
        myAdapter = new UniversalAdapter(view.getContext(), arrayList, "BEECH");
