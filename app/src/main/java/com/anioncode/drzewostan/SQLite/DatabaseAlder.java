...
public class DatabaseAlder extends SQLiteOpenHelper {
    final String tabelaNazwa="ALDER";
    public DatabaseAlder(Context context) {
        super(context, "las3.db", null, 1);
    }
    ...
    public Cursor AllData(){
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM ALDER ";
        Cursor data = db.rawQuery(query, null);
        return data;
    }
